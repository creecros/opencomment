 ...
 */
class newTaskModificationController extends BaseController
{
    /**
    ...
    public function start()
    {
        ...
        if (! $this->helper->projectRole->canCommentTask($task)) {
            throw new AccessForbiddenException(t('You are only allowed to comment.'));
        }
